        ...
        <>
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <article className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
              ...
              <p className="mt-1 text-sm text-emerald-600">+8% cette semaine</p>
            </article>
            <article className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
          ...
          <div className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
            ...
            <article className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
              <h2 className="text-xl font-semibold text-slate-900">Tickets par catégorie</h2>
              <div className="mt-6 space-y-4 text-sm text-slate-600">
                ...
                <div className="rounded-2xl bg-slate-50 p-4"><div className="flex justify-between"><span>Ouverts</span><strong>{data.ticketsByStatus.open}</strong></div></div>
                <div className="rounded-2xl bg-slate-50 p-4"><div className="flex justify-between"><span>Fermés</span><strong>{data.ticketsByStatus.closed}</strong></div></div>
              </div>
            </article>
          </div>
