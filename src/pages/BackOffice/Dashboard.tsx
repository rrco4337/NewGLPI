  ...
  return (
    <div style={{ padding: '32px 32px 48px', maxWidth: 1200, fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 16, marginBottom: 32 }}>
        <StatCard icon="bi-pc-display-horizontal"  label="Ordinateurs"    value={1248} color="#4f46e5" bgColor="#eef2ff" trend="+12%" trendUp />
        <StatCard icon="bi-ticket-detailed-fill"   label="Tickets actifs" value={56}   color="#0ea5e9" bgColor="#e0f2fe" trend="+3"   trendUp />
        <StatCard icon="bi-currency-euro"          label="Coûts ce mois"  value={12450} suffix="€" color="#10b981" bgColor="#d1fae5" trend="-8%" trendUp={false} />
        <StatCard icon="bi-people-fill"            label="Utilisateurs"   value={842}  color="#f59e0b" bgColor="#fef3c7" trend="+5"   trendUp />
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 20 }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
            ...
            <button style={{
              fontSize: 12.5, color: '#4f46e5', background: 'none',
